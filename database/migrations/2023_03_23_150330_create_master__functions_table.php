...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('master__functions', function (Blueprint $table) {
            $table->bigIncrements('function_id');
            $table->tinyInteger('parent_function_id');
    ...
    {
        Schema::dropIfExists('master__functions');
    }
};
