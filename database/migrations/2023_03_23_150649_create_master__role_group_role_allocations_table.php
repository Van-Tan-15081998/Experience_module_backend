...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('master__role_group_role_allocations', function (Blueprint $table) {
            $table->bigIncrements('role_group_role_allocation_id');
    ...
    {
        Schema::dropIfExists('master__role_group_role_allocations');
    }
};
