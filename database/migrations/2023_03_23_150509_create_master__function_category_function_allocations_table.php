...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('master__function_category_function_allocations', function (Blueprint $table) {
            $table->bigIncrements('function_category_function_allocation_id');
            $table->bigInteger('function_category_id');
    ...
    {
        Schema::dropIfExists('master__function_category_function_allocations');
    }
};
