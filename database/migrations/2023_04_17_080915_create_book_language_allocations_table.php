...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('favorite_app__book_language_allocations', function (Blueprint $table) {
//            $table->id();
//            $table->timestamps();

            $table->bigIncrements('book_language_allocation_id');
    ...
    {
        Schema::dropIfExists('favorite_app__book_language_allocations');
    }
};
