...
return new class extends Migration
{
    ...
    public function up()
    {
         ...
         **/
        Schema::create('kam__subject_knowledge_article_allocations', function (Blueprint $table) {
            $table->bigIncrements('subject_knowledge_article_allocation_id');
    ...
    {
        Schema::dropIfExists('kam__subject_knowledge_article_allocations');
    }
};
