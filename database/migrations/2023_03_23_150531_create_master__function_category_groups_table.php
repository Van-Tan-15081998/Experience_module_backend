...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('master__function_category_groups', function (Blueprint $table) {
            $table->bigIncrements('function_category_group_id');
    ...
    {
        Schema::dropIfExists('master__function_category_groups');
    }
};
