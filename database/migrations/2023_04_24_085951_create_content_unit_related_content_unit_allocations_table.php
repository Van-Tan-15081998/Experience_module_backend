...
return new class extends Migration
{
    ...
    public function up()
    {
         ...
         **/
        Schema::create('kam__content_unit_related_content_unit_allocations', function (Blueprint $table) {
            $table->bigIncrements('content_unit_related_content_unit_allocation_id');
            $table->bigInteger('content_unit_id');
            $table->bigInteger('related_content_unit_id');
    ...
    {
        Schema::dropIfExists('kam__content_unit_related_content_unit_allocations');
    }
};
