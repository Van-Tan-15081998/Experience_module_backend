...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('laravel_research__employee_positions', function (Blueprint $table) {
//            $table->id();
//            $table->timestamps();
            $table->bigInteger('employee_code');
            $table->bigInteger('position_code');
    ...
    {
        Schema::dropIfExists('laravel_research__employee_positions');
    }
};
