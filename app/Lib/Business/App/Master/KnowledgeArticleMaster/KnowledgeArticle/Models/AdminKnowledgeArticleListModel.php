...
class AdminKnowledgeArticleListModel extends DreamerTypeObject
{
    ...
    public static function createFromRecord($record): AdminKnowledgeArticleListModel {
        $model = new AdminKnowledgeArticleListModel();
