...
class AdminBookModel extends DreamerTypeObject
{
    private int         $bookId;
    ...
    // Ngoài ra các property dạng list cũng có thể khai báo ở model
    // private DreamerTypeList ...
    private DreamerTypeList $languageList;
     ...
     */
    public function getLanguageList(): DreamerTypeList
    {
        return $this->languageList;
    }

    /**
     * @param DreamerTypeList $languageList
     */
    public function setLanguageList(DreamerTypeList $languageList): void
    {
    ...
    public function init(): void
    {
        ...
        $this->languageList            = new DreamerTypeList([]);
        $this->publisherList           = new DreamerTypeList([]);
    ...
    public static function createFromRecord($record): AdminBookModel {
        $model = new AdminBookModel();
    ...
    public static function createFromRecordForEdit($record): AdminBookModel {
        $model = new AdminBookModel();
