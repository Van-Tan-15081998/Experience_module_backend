...
class BookDetailController extends BookBaseController
{
    ...
    public function initDisplay(Request $request): Response
    {
        ...
        if(!$role->isBrowse()) {
            ...
            $resultArray = $this->getInitialDisplayData($bookId, $mode, $role);
...
//    }
//
//    public function getCommonInfo(Request $request): Response
//    {
//
//    }
//
//    public function validateForm(BookUpdateRequest $request): Response
//    {
//
//    }
//
    public function register(BookUpdateRequest $request): Response
    {
...
//    }
    ...
    {
        return parent::getBookRole(AdminPageType::MASTER_FAVORITE_APP_BOOK_DETAIL(), $screenOptional);
    }

    private function getInitialDisplayData(int $bookId, string $mode, BookScreenRoleModel $role): array
    {
        ...
        try {
            ...
            $adminBook = $this->bookBusiness->getById(DetailsAction::fromKey($mode), $bookId);

            $data->addResponseItem('data', $adminBook);
        ...
        if ($isSucceeded) {
            ...
            if(DetailsAction::EDIT()->isSame($mode) || DetailsAction::NEW()->isSame($mode))  {
                ...
                try {
                    $selectionItems = $this->bookBusiness->getEditSelectionItems($adminBook);
                                                            ...
                                                            array $screenOptional=null      ): Response
    {
        return $this->apiResponseWithCommonFields(
            AdminPageType::MASTER_FAVORITE_APP_BOOK_DETAIL(),
